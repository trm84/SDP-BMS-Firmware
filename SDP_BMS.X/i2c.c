...
void i2cSetup(){
    TRISCbits.TRISC4 = 1; //i2c requires these be inputs
    TRISCbits.TRISC3 = 1; //i2c requires these be inputs
    
    APFCON1bits.SDISEL = 0; //SDA on RC4
    APFCON1bits.SCKSEL = 0; //SCL on RC3
